/**
 * Adapter de persistência para usuários usando JPA/Hibernate.
 * Implementa a porta de saída UserRepositoryPort, convertendo entidades JPA para o modelo de domínio.
